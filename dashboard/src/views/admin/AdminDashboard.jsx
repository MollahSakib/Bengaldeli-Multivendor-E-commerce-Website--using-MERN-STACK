...
import seller from '../../assests/seller.png';
...
const AdminDashboard = () => {
  ...
  const state = {
    series: [
      {
        name: 'Orders',
        data: [30, 6, 25, 65, 34, 34, 34, 56, 23, 67, 23, 45],
      },
      {
        name: 'Revenue',
      ...
      {
        name: 'Sellers',
        data: [45, 32, 34, 54, 65, 34, 54, 21, 54, 43, 45, 43],
      },
    ],
    options: {
      color: ['#181ee8', '#181ee8'],
    ...
    <div className="px-2 md:px-20 py-5">
      ...
      <div className="w-full flex flex-wrap mt-7">
        <div className="w-full lg:w-7/12 lg:pr-3">
          <div className="w-full bg-[#000000] p-4 rounded-md">
            <Chart
        ...
        <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
          <div className="w-full bg-[#000000] p-4 rounded-md text-[#ffffff]">
            <div className="flex justify-between items-center">
              <h2 className="font-semibold text-lg text-[#ffffff] pb-3">
                Recent seller messages
              </h2>
              <Link className="font-semibold text-sm text-[#ffffff]">
                View All
              </Link>
            </div>
            <div className="flex flex-col gap-2 pt-6 text-[#ffffff]">
              <ol className="relative border-1 border-slate-600 ml-4">
                {recentMessage.map((m, i) => (
                  ...
                  bg-[#00d1e848] rounded-full z-10"
                    ...
                    <div className="p-3 bg-green-1000 rounded-lg border border-slate-600 shawdow-sm">
      ...
      <div className="w-full p-4 bg-[#000000] rounded-md mt-6">
        <div className="flex justify-between items-center">
          <h2 className="font-semibold text-lg text-[#ffffff] pb-3">
            Recent orders
          </h2>
          <Link
            ...
            className="font-semibold text-sm text-[#ffffff]"
          >
            View All
          </Link>
        </div>
