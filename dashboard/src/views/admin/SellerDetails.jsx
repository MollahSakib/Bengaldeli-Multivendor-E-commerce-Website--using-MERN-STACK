      ...
      <div className="px-2 lg:px-7 pt-5">
        <div className="w-full p-4 bg-[#000000] rounded-md">
          <div className="w-full flex flex-wrap text-[#ffffff]">
            ...
            <div className="w-4/12 whitespace-nowrap">
              <div className="px-0 md:px-5 py-2">
                <div className="py-2 text-lg">
                  <h2>Basic Info </h2>
                </div>
                <div className="flex justify-between text-sm flex-col p-4 bg-slate-800 rounded-md">
          ...
          <div>
            <form onSubmit={submit}>
              <div className="flex gap-4 py-3">
                ...
                <button className="bg-green-500 hover:shadow-green-500/50 hover:shadow-lg text-white rounded-md px-7 py-2 w-[170px]">
                  Submit
                </button>
              </div>
            </form>
