...
const AddProduct = () => {
  ...
  const shopName = useSelector(
    (state) => state.auth.userInfo.shopInfo?.shopName
  );
    ...
    <div className="px-2 lg:px-7 pt-5 pb-4">
      <div className="w-full p-4 bg-[#000000] rounded-md">
        <div className="flex justify-between items-center pb-4">
          ...
          <Link
            className="bg-green-500 hover:shadow-green-500/50 hover:shadow-lg text-white rounded-md px-7 py-2 my-2"
          ...
          <form onSubmit={add}>
            ...
            <div className="flex flex-col mb-3 md:flex-row gap-4 w-full text-white">
              <div className="flex flex-col w-full gap-1 relative">
                ...
                <div
                  className={`absolute top-[101%] bg-black w-full transition-all ${
                ...
                >
                  <div className="w-full px-4 py-2 fixed">
                    <input
                      ...
                      className="px-4 py-1 w-full focus:border-indigo-500 outline-none border bg-black border-slate-700 rounded-md
                     text-[#ffffff] overflow-hidden"
                      type="text"
                      placeholder="search"
                    ></input>
                  </div>
            ...
            <div className="flex flex-col w-full gap-1 text-white">
              ...
              <textarea
                rows="4"
                className="px-3 py-2  focus:border-indigo-500 outline-none border bg-transparent border-slate-700 rounded-md text-[#ffffff] mb-5"
                onChange={inputHandle}
            ...
            <div className="grid lg:grid-cols-4 grid-cols-1 md:grid-cols-3 sm:grid-cols-2 sm:gap-4 md:gap-4 xs:gap-4 gap-3 w-full text-white mb-4">
              {imageShow.map((img, i) => (
                <div className="h-[180px] relative">
                  ...
                  <input
                    onChange={(e) => changImage(e.target.files[0], i)}
                    type="file"
                    id={i}
                    className="hidden"
                  />
            ...
            <button
              ...
              className=" w-[190px] bg-green-500 hover:shadow-green-500/50 hover:shadow-lg text-white rounded-md px-7 py-2 my-2 mb-3"
            >
              {loader ? (
