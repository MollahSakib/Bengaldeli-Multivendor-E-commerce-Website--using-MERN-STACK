  ...
  return (
    <div>
      <div
        ...
        bg-[#22292f80] top-0 left-0 z-10`}
      ></div>
      <div
        className={`w-[260px] fixed bg-[#000000] z-50 top-0 
          ...
          <ul>
                  ...
                  className={`${
                    pathname === n.path
                      ...
                      : 'text-[#d0d2d6] font-normal duration-200'
                            ...
                            justify-start items-center gap-[12px] hover:text-red-500 transition-all w-full mb-1}`}
                >
                  <span>{n.icon}</span>
                  <span>{n.title}</span>
                </Link>
            ...
            <li>
              <button
                ...
                className="text-[#d0d2d6] font-normal duration-200 px-[12px] py-[9px] rounded-sm flex
                            justify-start items-center gap-[12px] hover:text-red-500 transition-all w-full mb-1"
              >
                <span>
                  <BiLogInCircle />
